...
struct RobotContext
{
    ...
    // Apply the project stand pose (feet on floor, root_z = 0.81 m).
    // When setActualQ is true, both q and q_target are written.
    void   applyStandPose(bool setActualQ = false);
